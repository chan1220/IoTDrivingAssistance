...
"}")
        ...
        self.label_eco = QtWidgets.QLabel(self.widget_5)
        self.label_eco.setGeometry(QtCore.QRect(130, 53, 40, 40))
...
"}")
        ...
        self.gaugewidget.setGeometry(QtCore.QRect(0, 0, 385, 460))
        self.gaugewidget.setObjectName("gaugewidget")
        self.diagnosticwidget = DiagnosticWidget(self.widget_8)
        self.diagnosticwidget.setGeometry(QtCore.QRect(-1, -1, 385, 460))
        ...
        self.weatherwidget.setGeometry(QtCore.QRect(-1, -1, 385, 460))
