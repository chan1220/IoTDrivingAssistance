...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.GAUGE_rpm = RPMGauge(Form)
        self.GAUGE_rpm.setObjectName("GAUGE_rpm")
        self.horizontalLayout.addWidget(self.GAUGE_rpm)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.GAUGE_SPEED = SpeedGauge(Form)
        self.GAUGE_SPEED.setObjectName("GAUGE_SPEED")
        self.horizontalLayout_2.addWidget(self.GAUGE_SPEED)
